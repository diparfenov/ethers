...
const abi = [
    ...
    {
        inputs: [
            { internalType: "bytes32", name: "_bigBytes", type: "bytes32" },
        ],
        name: "setBigBytes",
        outputs: [],
    ...
    {
        inputs: [
            { internalType: "uint256", name: "_bigUint", type: "uint256" },
        ],
        name: "setBiglUint",
        outputs: [],
        stateMutability: "nonpayable",
    ...
    {
        inputs: [
            { internalType: "bytes1", name: "_smallBytes", type: "bytes1" },
        ],
        name: "setSmallBytes",
        outputs: [],
        stateMutability: "nonpayable",
...
//const primitives = new Contract(process.env.primitivesAddress, humanReadableAbi, defaultProvider);
